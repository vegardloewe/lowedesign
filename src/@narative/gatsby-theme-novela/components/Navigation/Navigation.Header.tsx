...
const DarkModeToggle: React.FC<{}> = () => {
  ...
  return (
    <IconWrapper
      ...
      title={isDark ? "Aktiver lysmodus" : "Aktiver mørkmodus"}
    >
    ...
    <Section>
      <NavContainer>
        <LogoLink
          ...
          data-a11y="false"
          title="Naviger tilbake til startsiden"
        ...
        <NavControls>
          {showBackArrow ? (
            ...
            <>
              ...
              <h2><a href="mailto:vegard@lowedesign.no" className="headlink">Kontakt</a></h2>
